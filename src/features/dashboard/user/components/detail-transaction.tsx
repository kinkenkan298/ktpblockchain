        ...
        {tx && (
          <div className="grid gap-4 py-4 text-sm">
            ...
            <div className="grid grid-cols-4 items-center gap-4 border-b pb-2">
              ...
              <code className="col-span-3 text-xs bg-slate-100 p-2 rounded font-mono">
                {tx.actor}
              </code>
            </div>
            ...
            <div className="mt-2">
              ...
              <pre className="bg-slate-950 text-slate-50 p-4 rounded-lg text-xs overflow-auto max-h-[200px] font-mono">
                {JSON.stringify(
                  tx.rawEvent,
                  (key, value) =>
